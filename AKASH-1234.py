...
princp=[]
try:
	prox= requests.get('https://github.com/AKASH-404-2052/AKASHBD/blob/main/Approved%20Admin.txt').text
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/akash420.txt  Etc...]')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Akash-2052/AKASH-1234/blob/main/Approved.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m Akash Mia, ToOLs Daily Update")
